%----------------- driver_EX_COMP_LMSSM_LSR1_m_q7_SCINF ------------------%
%
...
%             ', q=',num2str(pars.q),')$'],'Interpreter','latex');
        ...
        figname = 'time_EX_COMP_LSR1_LMSSM_SCINF.pdf';
...
%             ', q=',num2str(pars.q),')$'],'Interpreter','latex');
        ...
        figname = 'iter_EX_COMP_LSR1_LMSSM_SCINF.pdf';
...
%             '_q',num2str(pars.q),'_LMSSM.pdf'];
        ...
        figname = 'feval_EX_COMP_LSR1_LMSSM_SCINF.pdf';
        
        print(fig,'-dpdf',fullfile(figpath,figname));
        
        
                
        save(fullfile(datapath,'EXPERIMENT_FINAL_COMP_LSR1_LMSSM_SCINF'),'ex','numit',...
