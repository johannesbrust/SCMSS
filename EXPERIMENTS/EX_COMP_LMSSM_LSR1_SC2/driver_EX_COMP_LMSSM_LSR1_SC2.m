...
%
% sc_mssm_2.m        - Shape-changing infinity norm
%
...
leg={'$\textnormal{L-SR1:SC-INF}(m=',num2str(ms(1)),',q=',num2str(qs(1)),'$)',...
    '$\textnormal{L-MSS:SC-INF}(m=',num2str(ms(1)),',q=',num2str(qs(1)),'$)',...
    '$\textnormal{L-MSS:SC-INF}(m=',num2str(ms(2)),',q=',num2str(qs(2)),'$)'};
...
fprintf('----------- Running driver_EX_COMP_LMSSM_LSR1 --------------- \n');
...
%             ', q=',num2str(pars.q),')$'],'Interpreter','latex');
        ...
        figname = 'time_EX_COMP_LSR1_LMSSM_SC2.pdf';
...
%             ', q=',num2str(pars.q),')$'],'Interpreter','latex');
        ...
        figname = 'iter_EX_COMP_LSR1_LMSSM_SC2.pdf';
...
%             '_q',num2str(pars.q),'_LMSSM.pdf'];
        ...
        figname = 'feval_EX_COMP_LSR1_LMSSM_SC2.pdf';
        
        print(fig,'-dpdf',fullfile(figpath,figname));
        
        
                
        save(fullfile(datapath,'EXPERIMENT_FINAL_COMP_LSR1_LMSSM_SC2'),'ex','numit',...
