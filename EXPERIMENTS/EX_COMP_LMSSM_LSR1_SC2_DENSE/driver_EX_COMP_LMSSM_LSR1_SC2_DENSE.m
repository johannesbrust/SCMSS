%----------------- driver_EX_COMP_LMSSM_LSR1_SC2_DENSE -------------------%
%
% This script tests the Shape-changing infinity norm trust-region
% solvers using the L-MSS and L-SR1 matrix on a collection of 
% CUTEst problems.
...
%             ', q=',num2str(pars.q),')$'],'Interpreter','latex');
        ...
        figname = 'time_EX_COMP_LSR1_LMSSM_SC2_DENSE.pdf';
...
%             ', q=',num2str(pars.q),')$'],'Interpreter','latex');
        ...
        figname = 'iter_EX_COMP_LSR1_LMSSM_SC2_DENSE.pdf';
...
%             '_q',num2str(pars.q),'_LMSSM.pdf'];
        ...
        figname = 'feval_EX_COMP_LSR1_LMSSM_SC2_DENSE.pdf';
        
        print(fig,'-dpdf',fullfile(figpath,figname));
        
        
                
        save(fullfile(datapath,'EXPERIMENT_FINAL_COMP_LSR1_LMSSM_SC2_DENSE'),'ex','numit',...
