function [p_star,iExit]= sc_sr1_2(g,S_or_Psi,Y_or_invM,gamma_k,...
    delta,flag,show,varargin)
%sc_sr1_2: Implementation of the shape-changing l2 norm trust-region
% subproblem solver from article (Alg. 4)
%
