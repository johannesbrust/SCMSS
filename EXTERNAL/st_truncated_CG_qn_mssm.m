function [s1,As1,itn,exitflag] = st_truncated_CG_qn_mssm(g,Psi,invM,gamma_k,...
    delta,numMem,convergtol,itn_max,show,varargin)    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%                   with Psi)
% 06/10/22, J.Br., Modification to use with the MSS matrix
...
while ((itn<itn_max) & (exitflag==0))
  ...
  %if nargin==9  
    Ap0 = (gamma_k)*p0  + Psi(:,1:numMem) * (invM(1:numMem,1:numMem) * (Psi(:,1:numMem)'*p0));  %test this somehow
%   else
